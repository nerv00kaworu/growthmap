...
class AgentReadback(Base):
    ...
    project_id = Column(String(36), ForeignKey("projects.id", ondelete="CASCADE"), nullable=False, index=True)
    target_node_id = Column(String(36), ForeignKey("nodes.id", ondelete="SET NULL"), nullable=True)
    based_on_project_revision = Column(Integer, nullable=False, server_default="1")
    context_snapshot_digest = Column(String(64), nullable=False, server_default="")
    current_project_revision = Column(Integer, nullable=False, server_default="1")
    context_stale = Column(Boolean, nullable=False, default=False, server_default="1")
