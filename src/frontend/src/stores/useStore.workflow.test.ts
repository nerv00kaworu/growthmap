...
test("durable child undo uses exact authority before refresh and retires", async () => {
 ...
 const child={...root,id:"child",title:"child",revision:5,authoritative_project_revision:8,authoritative_parent_id:"root",authoritative_parent_revision:4} as GNode;let deleted=false;
