...
test("content-block and edge-update capabilities and shared/deferred documentation agree", async () => {
  ...
  assert.match(capabilities, /"operations":\[[^\]]*"update_edge"[^\]]*"update_content_block"[^\]]*"delete_content_block"/);
