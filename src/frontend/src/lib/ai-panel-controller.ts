...
export function createAIPanelController(d:AIPanelDeps){
 let alive=true,listGen=0,saveGen=0,testGen=0,state:AIPanelState={profiles:[...profileCache],profileState:profileCache.length?"ready":"loading",saving:false,modelError:null,test:null,copyMessage:null};const listeners=new Set<()=>void>();
