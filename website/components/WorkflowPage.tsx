...
en:{agents:'Work with agents',security:'View security',download:'View download status'},
readback:{'zh-TW':'實作讀回','zh-CN':'实现读回',en:'Implementation Readback'}} as const;
