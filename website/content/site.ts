...
export const faq=[['GrowthMap 是雲端專案管理工具嗎？','不是。GrowthMap 是 Windows 本機優先的專案工作區；公開網站不會接收專案資料。'],['目前可以購買或下載嗎？','Windows x64 下載與 Whop Personal v1 購買已開放；請只從 growthmap.work 取得安裝程式。']] as const;
