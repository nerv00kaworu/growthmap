...
export const licenseContent:Record<Locale,LicenseContent>={
  'zh-TW':{
    eyebrow:'PERSONAL 授權',title:'一次購買，永久使用 GrowthMap Personal。',
    lead:'解鎖不限同時啟用的專案，最多可在 2 台個人裝置使用。兩種價格提供相同的 Personal 授權內容。',
    plansLabel:'選擇 Personal 方案',
    ...
    includedTitle:'Personal 包含',included:['Personal 永久授權','不限同時啟用的專案數量','最多 2 台個人裝置'],
  ...
  'zh-CN':{
    eyebrow:'PERSONAL 授权',title:'一次购买，永久使用 GrowthMap Personal。',
    lead:'解锁不限同时启用的项目，最多可在 2 台个人设备使用。两种价格提供相同的 Personal 授权内容。',
    plansLabel:'选择 Personal 方案',
    ...
    includedTitle:'Personal 包含',included:['Personal 永久授权','不限同时启用的项目数量','最多 2 台个人设备'],
  ...
  en:{
    eyebrow:'PERSONAL LICENSE',title:'One purchase. Perpetual use of GrowthMap Personal.',
    lead:'Unlock unlimited active projects on up to 2 personal devices. Both prices include the same Personal license.',
    plansLabel:'Choose a Personal option',
    ...
    includedTitle:'Personal includes',included:['Perpetual Personal license','Unlimited simultaneously active projects','Up to 2 personal devices'],
