...
export const releaseCopy:Record<Locale,ReleaseCopy>={
  'zh-TW':{
    ...
    updateTitle:'日後如何更新',
    updateBody:'新版發布後，回到本頁下載新版安裝程式並直接覆蓋安裝。既有 Personal 授權、裝置身分與本機專案資料都會保留。',
  ...
  'zh-CN':{
    ...
    updateTitle:'以后如何更新',
    updateBody:'新版本发布后，回到本页下载新版安装程序并直接覆盖安装。现有 Personal 授权、设备身份和本地项目数据都会保留。',
  ...
  en:{
    ...
    updateBody:'When a new version is released, return to this page and install the new version over the existing app. Your Personal license, device identity, and local project data will remain in place.',
