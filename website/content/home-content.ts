...
type HomeCopy={
  ...
  closing:string;closingLead:string;explore:string;tree:{label:string;type?:string;evidence?:string}[];
};
...
const zhTW:HomeCopy={
  ...
  steps:[
    ...
    {label:'02 / 結構化',title:'變成有意義的節點',body:'概念、模組、任務、決策、風險、問題、資源與備註各自保留角色與關係。'},
