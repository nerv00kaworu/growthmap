...
export default async function LocaleLayout({children,params}:{children:React.ReactNode;params:Promise<{locale:string}>}){
 ...
 const links:[string,string][]=[[n.home,''],[n.features,'/features'],[n.agents,'/agents'],[n.security,'/security'],[n.download,'/download'],[n.buy,'/license']];const lang=locale==='zh-TW'?'zh-Hant':locale==='zh-CN'?'zh-Hans':'en';
