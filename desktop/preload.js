...
contextBridge.exposeInMainWorld('growthmapDesktop',Object.freeze({
 ...
 purchase:Object.freeze({open:rail=>ipcRenderer.invoke('purchase:open',rail),publicConfig:()=>ipcRenderer.invoke('commercial:public'),copyBasePayee:()=>ipcRenderer.invoke('commercial:copy-base-payee')}),
