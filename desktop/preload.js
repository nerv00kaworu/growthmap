...
contextBridge.exposeInMainWorld('growthmapDesktop',Object.freeze({
 ...
 agentAccess:Object.freeze({status:()=>ipcRenderer.invoke('agent-access:status'),enable:o=>ipcRenderer.invoke('agent-access:enable',o),disable:()=>ipcRenderer.invoke('agent-access:disable'),copy:()=>ipcRenderer.invoke('agent-access:copy'),download:()=>ipcRenderer.invoke('agent-access:download'),test:()=>ipcRenderer.invoke('agent-access:test'),regenerate:()=>ipcRenderer.invoke('agent-access:regenerate')}),
 secrets:Object.freeze({has:id=>ipcRenderer.invoke('secrets:has',id),set:(id,value)=>ipcRenderer.invoke('secrets:set',id,value),delete:id=>ipcRenderer.invoke('secrets:delete',id),recover:(id,revision,operation,value,operationId)=>ipcRenderer.invoke('secrets:recover',id,revision,operation,value,operationId)}),
