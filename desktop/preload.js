...
contextBridge.exposeInMainWorld('growthmapDesktop',Object.freeze({
 ...
 secrets:Object.freeze({has:id=>ipcRenderer.invoke('secrets:has',id),set:(id,value)=>ipcRenderer.invoke('secrets:set',id,value),delete:id=>ipcRenderer.invoke('secrets:delete',id),recover:(id,revision,operation,value)=>ipcRenderer.invoke('secrets:recover',id,revision,operation,value)}),
