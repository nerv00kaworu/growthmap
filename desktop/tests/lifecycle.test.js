...
test('entitlement probes capture output while long-lived Windows sidecars have no streams',()=>{
 ...
 assert.match(source,/lifecycle\.attach\(spawn\(executable\(\),\[\],\{env,\.\.\.sidecarSpawnOptions\(\)\}\)\)/);
