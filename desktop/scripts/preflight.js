...
if(process.env.GROWTHMAP_COMMERCIAL_RELEASE==='1'){
 ...
 const purchaseOrigin=commercial.purchasePortalOrigin||'',purchaseUrl=commercial.purchasePortalUrl||'',paypalUrl=commercial.paypalUrl||'';
