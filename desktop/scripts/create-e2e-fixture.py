...
CREATE TABLE nodes(id TEXT PRIMARY KEY,project_id TEXT NOT NULL,title TEXT NOT NULL,node_type TEXT NOT NULL,status TEXT NOT NULL,maturity TEXT,branch_id TEXT,workflow_status TEXT NOT NULL DEFAULT 'draft',file_paths JSON DEFAULT '[]',revision INTEGER NOT NULL DEFAULT 1);
