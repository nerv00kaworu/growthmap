...
const {launchArgs,timeoutDiagnostic,assertE2EAsar}=require('./renderer-e2e-support');
...
(async()=>{
 ...
 assertE2EAsar(path.join(path.dirname(executable),'resources','app.asar'));
