'use strict';
// JSON.parse-compatible scanner which rejects duplicate and Unicode-casefold-colliding
// object keys before JSON.parse can collapse them. It intentionally accepts JSON's
// ordinary whitespace/number/string grammar and delegates final syntax to JSON.parse.
