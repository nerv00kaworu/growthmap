...
if ($PSVersionTable.PSVersion.Major -lt 7) { throw 'Repository-local ASAR resolver requires PowerShell 7 or newer' }
...
# npm lockfiles use packages[""]; PowerShell 7 requires -AsHashtable to
# preserve and address an empty-string JSON property name fail-closed.
